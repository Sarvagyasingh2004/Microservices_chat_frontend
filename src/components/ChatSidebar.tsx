    ...
    >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {unseenCount > 0 && (
                          <div className="bg-red-600 text-white text-xs font-bold rounded-full h-5.5 flex items-center justify-center px-2 min-w-[22px]">
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-centr gap-3 px-4 py-3 rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white"
        >
